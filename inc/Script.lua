...
redis:set(terbo.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(terbo..'lock:join:'..msg.chat_id_,true)
...
redis:del(terbo..'lock:join:'..msg.chat_id_)
return "*♡ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n♡ ** تم فتح الدخول بالرابط \n*" 
end


local function iterbo(msg,MsgText)

Channel = redis:get(terbo..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(terbo..'joinchnl') then
...
redis:setex(terbo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(terbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(terbo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(terbo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(terbo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(terbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(terbo..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(terbo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(terbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(terbo..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(terbo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(terbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(terbo..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(terbo..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(terbo..'group:name'..msg.chat_id_) or '')
redis:set(terbo..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(terbo..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. terbo..'')
...
if not msg.Director and redis:get(terbo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(terbo..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(terbo..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(terbo..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(terbo..'admins:'..msg.chat_id_)
redis:del(terbo..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(terbo..'owners:'..msg.chat_id_)
redis:del(terbo..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(terbo..'whitelist:'..msg.chat_id_)
redis:del(terbo..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(terbo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(terbo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(terbo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(terbo..'linkGroup'..msg.sender_user_id_,300,true)
return '♡ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(terbo..'linkGroup'..msg.chat_id_) then 
return "♡ ** اوه لا يوجد رابط .\n♡ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(terbo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(terbo..'linkGroup'..msg.chat_id_)
...
local Text = "♡ رابـط الـمـجـمـوعه ♡ \n"..Flter_Markdown(redis:get(terbo..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(terbo..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(terbo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "♡ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(terbo..':Filter_Word:'..msg.chat_id_)
...
redis:del(terbo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(terbo..'welcome:msg'..msg.chat_id_) then 
return "♡ ** اوه هنالك خطأ .\n♡ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(terbo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(terbo..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♡ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(terbo..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(terbo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♡ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(terbo..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(terbo..'banned:'..msg.chat_id_)
if #list == 0 then return "*♡ لا يوجد مستخدمين محظورين  *" end
message = '♡ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(terbo..'banned:'..msg.chat_id_)
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."   \n♡  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(terbo..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "♡ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(terbo..'is_silent_users:'..msg.chat_id_)
...
redis:del(terbo..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "♡ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(terbo..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(terbo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♡ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(terbo..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(terbo..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(terbo..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(terbo..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(terbo..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(terbo..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(terbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(terbo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(terbo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(terbo.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(terbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(terbo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(terbo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(terbo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(terbo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(terbo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(terbo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(terbo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(terbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♡ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '♡ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "♡ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(terbo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "♡ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(terbo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(terbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(terbo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(terbo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(terbo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(terbo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(terbo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(terbo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(terbo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(terbo..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(terbo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(terbo..'welcome:msg'..msg.chat_id_))
else 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."  \n♡ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(terbo..'group:ids')
...
local pv = redis:smembers(terbo..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(terbo..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(terbo..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[♡ اهلا انا بوت]]..redis:get(terbo..':NameBot:')..[[ .
...
redis:setex(terbo..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '♡ حسننا عزيزي .\n♡ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(terbo..':addnumberusers',MsgText[2]) 
return '♡ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'♡ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(terbo..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
return '♡ ** عدد المجموعات المفعلة » `'..redis:scard(terbo..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
return '♡ **عدد المشتركين في البوت : `'..redis:scard(terbo..'users')..'` \n'
end
...
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(terbo..'group:ids',MsgText[2]) then
local name_gp = redis:get(terbo..'group:name'..MsgText[2])
...
return redis:get(terbo..":TEXT_SUDO") or '♡ لا توجد كليشه المطور .\n♡ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"♡ **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(terbo..'lock_brod') then return "♡ ** الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(terbo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "♡ حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♡ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(terbo..'lock_brod') then 
return "♡ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(terbo..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(terbo..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(terbo..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(terbo..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(terbo..'welcom:witting'..msg.sender_user_id_,
terbo..'rulse:witting'..msg.sender_user_id_,
terbo..'rulse:witting'..msg.sender_user_id_,
terbo..'name:witting'..msg.sender_user_id_,
terbo..'about:witting'..msg.sender_user_id_,
terbo..'fwd:all'..msg.sender_user_id_,
terbo..'fwd:pv'..msg.sender_user_id_,
terbo..'fwd:groups'..msg.sender_user_id_,
terbo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
terbo..'namebot:witting'..msg.sender_user_id_,
terbo..'addrd_all:'..msg.sender_user_id_,
terbo..'delrd:'..msg.sender_user_id_,
terbo..'addrd:'..msg.sender_user_id_,
terbo..'delrdall:'..msg.sender_user_id_,
terbo..'text_sudo:witting'..msg.sender_user_id_,
terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/jack1eljoker1/terbofiles/main/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(terbo..":VERSION",GetVerison)
return false
else
...
return '♡ اصدار سورس تربو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'♡ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس تربو يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/ter_bo7"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : تربو](https://t.me/ter_bo7)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '♡ الاحصائيات . \n\n♡ **عدد المجموعات المفعله : '..redis:scard(terbo..'group:ids')..'\n♡ **عدد المشتركين في البوت : '..redis:scard(terbo..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(terbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(terbo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(terbo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(terbo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(terbo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(terbo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(terbo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(terbo..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(terbo..'replay:'..msg.chat_id_,terbo..'replay_photo:group:'..msg.chat_id_,terbo..'replay_voice:group:'..msg.chat_id_,
terbo..'replay_animation:group:'..msg.chat_id_,terbo..'replay_audio:group:'..msg.chat_id_,terbo..'replay_sticker:group:'..msg.chat_id_,terbo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(terbo..'replay:all')
local photo 	= redis:exists(terbo..'replay_photo:group:')
local voice 	= redis:exists(terbo..'replay_voice:group:')
local imation 	= redis:exists(terbo..'replay_animation:group:')
local audio 	= redis:exists(terbo..'replay_audio:group:')
local sticker 	= redis:exists(terbo..'replay_sticker:group:')
local video 	= redis:exists(terbo..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(terbo..'replay:all',terbo..'replay_photo:group:',terbo..'replay_voice:group:',terbo..'replay_animation:group:',terbo..'replay_audio:group:',terbo..'replay_sticker:group:',terbo..'replay_video:group:')
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(terbo..'delrdall:'..msg.sender_user_id_,true) 
return "♡ حسننا عزيزي  .\n♡ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(terbo..'delrd:'..msg.sender_user_id_,true)
return "♡ حسننا عزيزي  .\n♡ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♡ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(terbo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(terbo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(terbo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(terbo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(terbo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(terbo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(terbo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(terbo..'replay:all')
local photo 	= redis:hkeys(terbo..'replay_photo:group:')
local voice 	= redis:hkeys(terbo..'replay_voice:group:')
local imation 	= redis:hkeys(terbo..'replay_animation:group:')
local audio 	= redis:hkeys(terbo..'replay_audio:group:')
local sticker 	= redis:hkeys(terbo..'replay_sticker:group:')
local video 	= redis:hkeys(terbo..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '♡ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(terbo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "♡ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(terbo..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n♡ " end
if not redis:get(terbo..'lave_me'..msg.chat_id_) then 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** المغادره بالتاكيد تم تفعيلها\n♡" 
else 
redis:del(terbo..'lave_me'..msg.chat_id_) 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** تم تفعيل المغادره \n♡" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n♡ " end
if redis:get(terbo..'lave_me'..msg.chat_id_) then 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** المغادره من قبل البوت بالتأكيد معطله\n♡" 
else
redis:set(terbo..'lave_me'..msg.chat_id_,true)  
...
return [[
 ♡ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ♡
ــــــــــــــــــــــ♡ـــــــــــــــــــــ
♡ 𝐷𝐸𝑉 >> [˹ Developer   .](t.me/SIRIA199)
ــــــــــــــــــــــ♡ـــــــــــــــــــــ 
♡ 𝐷𝐸𝑉 >> [˹ Developer  .](t.me/ALMOFTARESs)
ــــــــــــــــــــــ♡ـــــــــــــــــــــ
♡ـــ♡ >> [˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 .](t.me/ter_bo7)
ــــــــــــــــــــــ♡ـــــــــــــــــــــ
♡ـــ♡>> [˹ 𝑇𝑂 𝑇𝐴𝐿𝐾 𝐹𝑂𝑅 𝑈𝑆 .](t.me/@twasol6bot)
ــــــــــــــــــــــ♡ـــــــــــــــــــــ
]]
end
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(terbo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(terbo..":UserNameChaneel")
if UserChaneel then
...
if redis:get(terbo..'welc'..msg.chat_id_) == 'on' then
if msg.content_.ID == 'MessageChatJoinByLink' then
function WelcomeByAddUser(terbo,Diamond)
...
local hash = terbo..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
terbo = msg.text 
if terbo == 'رفع مشرف كامل' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(terbo,diamond)
...
if terbo == 'رفع مشرف' and msg.reply_to_message_id_ ~= 0 then
...
if terbo == 'تنزيل مشرف' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function remadmins(terbo,diamond)
...
mmd = redis:get(terbo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(terbo..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(terbo..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'♡ اهلا عزيزي \n♡ تم تثبيت الامر الجديد\n♡')
redis:del(terbo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if terbo:match('تغير امر (.*)') then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = terbo:match('تغير امر (.*)') 
redis:setex(terbo..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'♡ اهلا بك عزيزي\n♡ الامر الي تريد تغيره الي  "'..cmd..'" \n♡ ارسله الان\n')
end

if terbo and (terbo:match('^delcmd (.*)') or terbo:match('^مسح امر (.*)')) then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = terbo:match('^delcmd (.*)') or terbo:match('^مسح امر (.*)')
redis:hdel(terbo..'CmD:'..msg.chat_id_,cmd)
redis:srem(terbo..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"♡ اهلا عزيزي\nالامر >"..cmd.."\n♡ تم مسحه من قائمه الاوامر\n")
end
if terbo == 'مسح قائمه الاوامر' or terbo == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(terbo..'CmD:'..msg.chat_id_)
redis:del(terbo..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♡ اهلا عزيزي تم مسح قائمه الاوامر")
end
if terbo == "قائمه الاوامر" then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(terbo..'CmDlist:'..msg.chat_id_)
local t = '♡ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(terbo..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
if terbo == 'welcome on' or terbo == 'تفعيل الترحيب' then
if redis:get(terbo..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الترحيب سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الترحيب')
redis:set(terbo..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(terbo..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(terbo..'welc'..msg.chat_id_,'off')
redis:del(terbo..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if terbo == 'welcome on' or terbo == 'تفعيل التربو تيم' then
if redis:get(terbo..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل التربو تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل التربو تيم')
redis:set(terbo..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم التربو' then
if redis:get(terbo..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم التربو سابقا')
redis:set(terbo..'welc'..msg.chat_id_,'off')
redis:del(terbo..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم التربو الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(terbo..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(terbo..'setchs') and msg.SudoUser then
redis:set(terbo..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(terbo..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(terbo..'setchs',120,true)
end
...
function tophoto(kara,terbo)   
if terbo.content_.ID == "MessageSticker" then        
local bd = terbo.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(terbo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(terbo..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*♡ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(terbo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس تربو\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
{"تفعيل التربو تيم","تعطيل تيم التربو"},
...
redis:sadd(terbo..'users',msg.sender_user_id_)
if redis:get(terbo..'lock_service') then 
text = [[♡ أهلاً انا بوت   []]..redis:get(terbo..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(terbo.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(terbo..'lock_twasel') then
...
redis:setex(terbo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(terbo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(terbo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(terbo..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n♡ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(terbo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه صوره للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(terbo..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه بصمه صوت للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(terbo..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه متحركه للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(terbo..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه فيديو للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(terbo..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه للصوت للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(terbo..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(terbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(terbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(terbo..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ♡ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(terbo..'replay_photo:group:',klma,photo_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه صوره للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(terbo..'replay_voice:group:',klma,voice_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه بصمه صوت للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(terbo..'replay_animation:group:',klma,animation_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه متحركه للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(terbo..'replay_video:group:',klma,video_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه فيديو للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(terbo..'replay_audio:group:',klma,audio_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه للصوت للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(terbo..'replay_sticker:group:',klma,sticker_id)
redis:del(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(terbo..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(terbo..":ForceSub:"..msg.sender_user_id_)
...
redis:set(terbo..":UserNameChaneel",msg.text)
...
if redis:get(terbo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(terbo..'namebot:witting'..msg.sender_user_id_)
redis:set(terbo..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"♡ تم تغير اسم البوت  .\n♡ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(terbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(terbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(terbo..'replay_photo:group:',msg.text)
redis:hdel(terbo..'replay_voice:group:',msg.text)
redis:hdel(terbo..'replay_animation:group:',msg.text)
redis:hdel(terbo..'replay_audio:group:',msg.text)
redis:hdel(terbo..'replay_sticker:group:',msg.text)
redis:hdel(terbo..'replay_video:group:',msg.text)
redis:setex(terbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ جيد , يمكنك الان ارسال جوا ب الردالعام \n♡ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(terbo..'delrdall:'..msg.sender_user_id_) then
redis:del(terbo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(terbo..'replay:all',msg.text)
local photo =redis:hget(terbo..'replay_photo:group:',msg.text)
local voice = redis:hget(terbo..'replay_voice:group:',msg.text)
local animation = redis:hget(terbo..'replay_animation:group:',msg.text)
local audio = redis:hget(terbo..'replay_audio:group:',msg.text)
local sticker = redis:hget(terbo..'replay_sticker:group:',msg.text)
local video = redis:hget(terbo..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'♡ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(terbo..'replay:all',msg.text)
redis:hdel(terbo..'replay_photo:group:',msg.text)
redis:hdel(terbo..'replay_voice:group:',msg.text)
redis:hdel(terbo..'replay_audio:group:',msg.text)
redis:hdel(terbo..'replay_animation:group:',msg.text)
...
if redis:get(terbo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(terbo..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(terbo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "♡ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(terbo..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(terbo..'welcom:witting'..msg.sender_user_id_) 
redis:set(terbo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(terbo..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(terbo..'rulse:witting'..msg.sender_user_id_) 
redis:set(terbo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'♡ ** مرحبآ عزيزي\n♡ تم حفظ القوانين بنجاح .\n♡ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(terbo..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(terbo..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(terbo..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(terbo..'linkGroup'..msg.sender_user_id_,link) 
redis:set(terbo..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'♡ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(terbo..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(terbo..'about:witting'..msg.sender_user_id_) 
...
if redis:get(terbo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(terbo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(terbo..'users')  
local groups = redis:smembers(terbo..'group:ids')
...
if redis:get(terbo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(terbo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(terbo..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(terbo..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'♡ **عدد المجموعات { *'..#groups..'*  } ⊰•\n♡ **تـم الاذاعه بالتثبيت بنجاح ♥')
end

if redis:get(terbo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(terbo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(terbo..'users')
if #pv >= 300 then
...
if redis:get(terbo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(terbo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(terbo..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'♡ اهلا عزيزي المطور \n♡ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.adduser and msg.adduser == our_id and redis:get(terbo..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(terbo..':WELCOME_BOT'),[[♡أهلاً انا بوت ]]..redis:get(terbo..':NameBot:')..[[
♡ أختصاصي حماية‌‏ المجموعات
♡ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(terbo..'fwd:'..msg.sender_user_id_) then
redis:del(terbo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(terbo..'users')
local groups = redis:smembers(terbo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(terbo..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(terbo..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(terbo..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(terbo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(terbo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(terbo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(terbo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(terbo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(terbo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(terbo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ جيد , يمكنك الان ارسال جواب الرد \n♡ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(terbo..'delrd:'..msg.sender_user_id_) then
redis:del(terbo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(terbo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(terbo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(terbo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(terbo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(terbo..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(terbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(terbo..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'♡ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(terbo..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(terbo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(terbo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(terbo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(terbo..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(terbo..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(terbo..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(terbo..'welcome:msg'..msg.chat_id_) or "♡ اهلاً عزيزي {الاسم}\n♡ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(terbo..'rulse:msg'..msg.chat_id_) or "♡ مرحباً عزيري القوانين كلاتي .\n♡ ممنوع نشر الروابط\n♡ ممنوع التكلم او نشر صور اباحيه\n♡ ممنوع  اعاده توجيه\n♡ ممنوع التكلم بالسياسة\n♡ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(terbo..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(terbo..'welcome:msg'..msg.chat_id_) or "♡ اهلن بك عزيزي {الاسم}\n♡ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(terbo..'rulse:msg'..msg.chat_id_) or "♡ مرحباً عزيري القوانين كلاتي .\n♡ ممنوع نشر الروابط\n♡ ممنوع التكلم او نشر صور اباحيه\n♡ ممنوع  اعاده توجيه\n♡ ممنوع التكلم بالسياسة\n♡ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(terbo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(terbo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(terbo..'welcome:get'..msg.chat_id_)
end
redis:setex(terbo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(terbo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(terbo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_terbo = (redis:get(terbo..'num_msg_terbo'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_terbo) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(terbo..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"♡ العضو » "..USERNAME.."\n♡ قمـت بتكرار اكثر مـن "..NUM_MSG_terbo.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(terbo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(terbo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(terbo..'lock_woring'..msg.chat_id_) and not redis:get(terbo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(terbo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(terbo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(terbo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'♡ ** لا يمكنني مسح الرساله المخالفه .\n♡ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(terbo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(terbo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(terbo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(terbo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(terbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(terbo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(terbo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(terbo..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(terbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(terbo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(terbo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(terbo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(terbo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(terbo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(terbo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(terbo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(terbo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(terbo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(terbo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(terbo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(terbo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(terbo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(terbo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(terbo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(terbo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(terbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(terbo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(terbo..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(terbo..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(terbo..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(terbo..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(terbo..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(terbo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(terbo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(terbo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "رفع التربو"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ لقد تم رفع تربو بنجاح \n♡ اديلو تربو\n")
elseif Text== "تنزيل التربو"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ لقد تم رفع تربو بنجاح \n♡ اديلو تربو\n")
...
elseif Text== "رفع تربو"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ تم رفع الواد ضمن الزنوج بنجاح\n♡الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل تربو"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ تم ازاله الواد بعيدا عن الزنوج بنجاح \n♡الان تم ازلته من قائمه الزنوج\n")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس تربو/n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/terbo_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/terbo_TEAM_4)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/terbo_TEAM_4)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/terbo_TEAM_4)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/terbo_TEAM_4)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/terbo_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/terbo_TEAM_4)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/terbo_TEAM_4)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/terbo_TEAM_4)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/terbo_TEAM_4)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..terbo..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(terbo..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(terbo..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(terbo..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(terbo..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(terbo..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(terbo..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(terbo..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(terbo..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(terbo..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'♡ انتهى الاشتراك في احد المجموعات .\n♡ المجموعه : '..FlterName(redis:get(terbo..'group:name'..msg.chat_id_))..'.\n♡ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'♡ انتهى الاشتراك البوت.\n♡ سوف اغادر المجموعه فرصه سعيده .\n♡ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(terbo..'ExpireDate:'..msg.chat_id_) / 86400)
