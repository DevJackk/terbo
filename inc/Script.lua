...
send_key(msg.sender_user_id_,'   [قناة سورس : تيربو](https://t.me/ter_bo7)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "جاك المبرمج" and msg.type == "pv" then
...
if MsgText[1]== "جوكر المبرمج" and msg.type == "pv" then
