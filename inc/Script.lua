...
function send_inline(chat_id,text,keyboard,terbodown)
local url = Bot_Api
if keyboard then
url = url .. '/sendMessage?chat_id=' ..chat_id.. '&text='..URL.escape(text)..'&parse_mode=html&reply_terboup='..URL.escape(json:encode(keyboard))
else
url = url .. '/sendMessage?chat_id=' ..chat_id.. '&text='..URL.escape(text)..'&parse_mode=HTML'
end
if terbodown == 'md' or terbodown == 'terbodown' then
url = url..'&parse_mode=Terbodown'
elseif terbodown == 'html' then
...
if MsgText[2] == "الماركدوان" 	then return lock_terbodown(msg) end
...
if MsgText[2] == "الماركدوان" 	then return unlock_terbodown(msg) end
...
local Text = "𖤐 رابـط الـمـجـمـوعه 𖤐 \n"..Flter_Terbodown(redis:get(terbo..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
local info, res = https.request(ApiToken..'/sendMessage?chat_id='..msg.sender_user_id_..'&text='..URL.escape(Text)..'&disable_web_page_preview=true&parse_mode=Terbodown')
if res == 403 then
...
if redis:get(terbo.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		Text = Text:gsub('adduser',NumGha)
		Text = Text:gsub('User_Points',nko)
		sendMsg(msg.chat_id_,msg.id_,Flter_Terbodown(Text))
		end
	end
else
...
return '𖤐 **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(terbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end
...
return Flter_Terbodown(redis:get(terbo..'welcome:msg'..msg.chat_id_))
else 
return "𖤐 **أهلا عزيزي "..msg.TheRankCmd.."  \n𖤐 نورت المجموعه \n" 
end 
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[𖤐 اهلا انا بوت]]..redis:get(terbo..':NameBot:')..[[ .
...
return'𖤐 ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(terbo..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤐 ** عدد المجموعات المفعلة » `'..redis:scard(terbo..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤐 **عدد المشتركين في البوت : `'..redis:scard(terbo..'users')..'` \n'
end
...
return redis:get(terbo..":TEXT_SUDO") or '𖤐 لا توجد كليشه المطور .\n𖤐 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
send_key(msg.sender_user_id_,'   [قناة سورس : ter_bo7](https://t.me/ter_bo7)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '𖤐 الاحصائيات . \n\n𖤐 **عدد المجموعات المفعله : '..redis:scard(terbo..'group:ids')..'\n𖤐 **عدد المشتركين في البوت : '..redis:scard(terbo..'users')..'\n'
end
---------------[End Function data] -----------------------
...
local text = " مرحبا بك في سورس تربو "
local inline = {
{{text = '-𝒔𝒐𝒖𝒓𝒄𝒆 𝒅𝒆𝒗¹  .',url="https://t.me/SIRIA199"}},
{{text = '- 𝒔𝒐𝒖𝒓𝒄𝒆 𝒅𝒆𝒗² .',url="https://t.me/ALMOFTARESs"}},
{{text = '- 𝐬𝐨𝐮𝐫𝐜𝐞 .',url="https://t.me/ter_bo7"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
}   
send_inline(msg.chat_id_,  "Welcome to SourceTerbo" ,keyboard,'html')
end
...
return '𖤐 **عدد سحكاتك ⇜ ❪ '..(redis:get(terbo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
text = [[𖤐 أهلاً انا بوت   []]..redis:get(terbo..':NameBot:')..[[] 🗽
...
if msg.text then
sendMsg(FwdUser,MSG_ID,Flter_Terbodown(msg.text))
...
if msg.text then 
redis:hset(terbo..'replay:'..msg.chat_id_,klma,Flter_Terbodown(msg.text))
...
if msg.text then
redis:hset(terbo..'replay:all',klma,Flter_Terbodown(msg.text))
...
redis:hdel(terbo..'replay_sticker:group:',msg.text)
redis:hdel(terbo..'replay_video:group:',msg.text)
return sendMsg(msg.chat_id_,msg.id_,'('..Flter_Terbodown(msg.text)..')\n𖤐 تم مسح الرد . ')
end 
end 
...
redis:set(terbo..':TEXT_SUDO',Flter_Terbodown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "𖤐 ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Terbodown(msg.text).."  *}*\n")
end
...
redis:set(terbo..'rulse:msg'..msg.chat_id_,Flter_Terbodown(msg.text)) 
...
redis:set(terbo..'linkGroup'..msg.chat_id_,Flter_Terbodown(msg.text)) 
...
for i = 1, #pv do 
sendMsg(pv[i],0,Flter_Terbodown(msg.text),nil,function(arg,data)
if data.send_state_ and data.send_state_.ID == "MessageIsBeingSent"  then
print("Sender Ok")
else
print("Rem user From list")
redis:srem(terboTerbo..'users',pv[i])
end
end)
end
for i = 1, #groups do 
sendMsg(groups[i],0,Flter_Terbodown(msg.text),nil,function(arg,data)
if data.send_state_ and data.send_state_.ID == "MessageIsBeingSent"  then
print("Sender Ok")
else
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(terbo..':WELCOME_BOT'),[[𖤐أهلاً انا بوت ]]..redis:get(terbo..':NameBot:')..[[
𖤐 أختصاصي حماية‌‏ المجموعات
𖤐 مـن السبام والتوجيه‌‏ والتكرار والخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(terbo..'welcome:msg'..msg.chat_id_) or "𖤐 اهلاً عزيزي {الاسم}\n𖤐 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤐 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(terbo..'rulse:msg'..msg.chat_id_) or "𖤐 مرحباً عزيري القوانين كلاتي .\n𖤐 ممنوع نشر الروابط\n𖤐 ممنوع التكلم او نشر صور اباحيه\n𖤐 ممنوع  اعاده توجيه\n𖤐 ممنوع التكلم بالسياسة\n𖤐 الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Terbodown((redis:get(terbo..'group:name'..msg.chat_id_) or '')))
...
sendMsg(msg.chat_id_,msg.id_,Flter_Terbodown(welcome))
end 
end)
else
welcome = (redis:get(terbo..'welcome:msg'..msg.chat_id_) or "𖤐 اهلن بك عزيزي {الاسم}\n𖤐 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤐 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(terbo..'rulse:msg'..msg.chat_id_) or "𖤐 مرحباً عزيري القوانين كلاتي .\n𖤐 ممنوع نشر الروابط\n𖤐 ممنوع التكلم او نشر صور اباحيه\n𖤐 ممنوع  اعاده توجيه\n𖤐 ممنوع التكلم بالسياسة\n𖤐 الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"𖤐 العضو » "..USERNAME.."\n𖤐 قمـت بتكرار اكثر مـن "..NUM_MSG_terbo.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(terbo..'lock_terbodown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send terbodown \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𖤐 ** لا يمكنني مسح الرساله المخالفه .\n𖤐 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(terbo..'lock_woring'..msg.chat_id_) then
...
return false
elseif msg.replyTerboupInlineKeyboard and redis:get(terbo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "سورس تربو" then return  sendMsg(msg.chat_id_,msg.id_,"[افجر سورس مصري  𖠲](https://t.me/RISK_00)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/ter_bo7) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/ter_bo7)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/ter_bo7)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/ter_bo7)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/ter_bo7)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/ter_bo7) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/ter_bo7)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ter_bo7)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ter_bo7)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ter_bo7)")
...
if not redis:get('kar') then
  ...
  sendMsg(SUDO_ID,0,'𖤐 انتهى الاشتراك في احد المجموعات .\n𖤐 المجموعه : '..FlterName(redis:get(terbo..'group:name'..msg.chat_id_))..'.\n𖤐 ايدي : '..msg.chat_id_)
